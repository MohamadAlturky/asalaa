...
const DATA: Record<AppLocale, ExploreSyriaPageContent> = {
  ar: {
    ...
    heroImageSrc: '/asalaa/images/explore/door.svg',
    ...
    posts: [
      {
        ...
        authorAvatarSrc: '/asalaa/images/avatar-placeholder.svg',
        timeLabel: 'منذ دقيقة',
        body:
      ...
      },
      {
        ...
        imageSrc: '/asalaa/images/explore/tile-palmyra.svg',
        imageAlt: 'أطلال تدمر',
        likeCount: 48,
        commentCount: 11,
      },
      {
        ...
        imageSrc: '/asalaa/images/explore/tile-norias.svg',
    ...
    tiles: [
      { id: 'palmyra', kind: 'video', src: '/asalaa/images/explore/tile-palmyra.svg', alt: 'مشهد أثري', layout: 'palmyra' },
      { id: 'fortress-night', kind: 'video', src: '/asalaa/images/explore/tile-fortress-night.svg', alt: 'قلعة مضاءة ليلاً', layout: 'fortressNight' },
      { id: 'emblem', kind: 'brandTile', alt: '', layout: 'emblem' },
      { id: 'stained', kind: 'gallery', src: '/asalaa/images/explore/tile-stained-glass.svg', alt: 'زجاج ملون', layout: 'stainedGlass' },
      { id: 'clock', kind: 'video', src: '/asalaa/images/explore/tile-clock-tower.svg', alt: 'برج ساعة وقبة', layout: 'clockTower' },
      { id: 'norias', kind: 'gallery', src: '/asalaa/images/explore/tile-norias.svg', alt: 'نواعير حماة', layout: 'norias' },
      { id: 'street', kind: 'gallery', src: '/asalaa/images/explore/tile-street.svg', alt: 'زقاق تاريخي', layout: 'street' },
      { id: 'hill-fort', kind: 'image', src: '/asalaa/images/explore/tile-hill-fort.svg', alt: 'قلعة على تل', layout: 'hillFort' },
      { id: 'souq', kind: 'video', src: '/asalaa/images/explore/tile-souq.svg', alt: 'سقف سوق حجري', layout: 'souq' },
      { id: 'interior', kind: 'video', src: '/asalaa/images/explore/tile-interior.svg', alt: 'قاعة بأقواس حجرية', layout: 'interior' },
    ],
  },
  en: {
    title: 'Explore Syria',
    ...
    tiles: [
      { id: 'palmyra', kind: 'video', src: '/asalaa/images/explore/tile-palmyra.svg', alt: 'Ancient amphitheatre scene', layout: 'palmyra' },
      { id: 'fortress-night', kind: 'video', src: '/asalaa/images/explore/tile-fortress-night.svg', alt: 'Fortress at night', layout: 'fortressNight' },
      { id: 'emblem', kind: 'brandTile', alt: '', layout: 'emblem' },
      { id: 'stained', kind: 'gallery', src: '/asalaa/images/explore/tile-stained-glass.svg', alt: 'Stained glass window', layout: 'stainedGlass' },
      { id: 'clock', kind: 'video', src: '/asalaa/images/explore/tile-clock-tower.svg', alt: 'Clock tower and dome', layout: 'clockTower' },
      { id: 'norias', kind: 'gallery', src: '/asalaa/images/explore/tile-norias.svg', alt: 'Norias of Hama', layout: 'norias' },
      { id: 'street', kind: 'gallery', src: '/asalaa/images/explore/tile-street.svg', alt: 'Historic alley', layout: 'street' },
      { id: 'hill-fort', kind: 'image', src: '/asalaa/images/explore/tile-hill-fort.svg', alt: 'Fortress on a green hill', layout: 'hillFort' },
      { id: 'souq', kind: 'video', src: '/asalaa/images/explore/tile-souq.svg', alt: 'Stone souq ceiling', layout: 'souq' },
      { id: 'interior', kind: 'video', src: '/asalaa/images/explore/tile-interior.svg', alt: 'Arched stone hall', layout: 'interior' },
    ],
  },
}
